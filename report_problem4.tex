...
\texttt{main.py}           & NI and interactive-hash prover/verifier\\
...
(non-interactive, after running \texttt{main.py prover --mode noninteractive})}]
{
  "mode": "noninteractive",
  "transcript": {
    "T_list": [552, 212, 26],
...
python main.py verifier                       # ACCEPT
...
python main.py verifier                       # REJECT
\end{lstlisting}
